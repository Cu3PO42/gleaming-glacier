# This file is derived from NixOS/nixpkgs/nixos/lib/make-iso9660-image.sh
...
# TODO: add the ability to add extra included paths

# Adjusted: Added a definition for $out
out="$(pwd)"
...
if test -n "$compressImage"; then
    ...
    # Adjusted: removed the -T$NIX_BUILD_CORES flag
    zstd --rm $out/iso/$isoName
fi
